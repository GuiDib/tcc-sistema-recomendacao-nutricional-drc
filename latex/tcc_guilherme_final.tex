...
\hline
G1 (TFG $\geq$ 90)  & 49 & 1  & 2  \\
\hline
G2 (TFG 60--89)      & 49 & 1  & 2  \\
\hline
G3a (TFG 45--59)     & 39 & 6  & 7  \\
\hline
G3b (TFG 30--44)     & 18 & 15 & 19 \\
\hline
G4 (TFG 15--29)      & 10 & 13 & 29 \\
\hline
G5 (TFG $<$ 15)      & 4  & 8  & 40 \\
\hline
\end{tabular}
...
A arquitetura orientada a conhecimento demonstrou capacidade de gerar recomendações explicáveis, rastreáveis e aderentes às diretrizes KDIGO/KDOQI. A progressão das restrições de G1 a G5 --- de 49 alimentos permitidos no estágio inicial para apenas 4 no estágio de diálise --- confirma que o sistema responde adequadamente à gravidade da doença. A inclusão de justificativas semânticas em cada classificação diferencia o OntoDRC de abordagens baseadas exclusivamente em aprendizado de máquina, que frequentemente operam sem transparência no processo decisório.
